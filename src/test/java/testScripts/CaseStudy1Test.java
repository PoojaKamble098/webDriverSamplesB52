...
public class CaseStudy1Test {
  ...
  public void LoginTest() {
	  ...
	  wait.until(ExpectedConditions.elementToBeClickable(By.id("loginusername"))).sendKeys("Poi098");
	  wait.until(ExpectedConditions.elementToBeClickable(By.id("loginpassword"))).sendKeys("Tester234");
	  ...
	  Assert.assertEquals(Loggedinuser.getText(), "Welcome Poi098");
  ...
  public void AddToCartTest() {
	 ...
	 // action.scrollToElement(driver.findElement(By.xpath("//div/a[@class='list-group-item' and contains(text(),'Phones')]"))).perform();
	  action.scrollToElement(driver.findElement(By.id("//[@id='itemc']")));
	  ...
	  public void PurchaseTest() {
		  ...
		  driver.findElement(By.xpath("//button[@class='btn btn-primary' and contains(tect(), 'Purchase')]")).click();
